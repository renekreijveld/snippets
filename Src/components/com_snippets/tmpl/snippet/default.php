                ...
                <?php if (Factory::getApplication()->getIdentity()->authorise('core.delete', 'com_snippets.snippet.' . $this->item->id)) : ?>
                    ...
                    <?= HTMLHelper::_(
                        ...
                        array(
                            ...
                            'modalWidth' => '50',
                            'bodyHeight' => '100',
                            'footer'     => '<button class="btn btn-primary btn-sm" data-bs-dismiss="modal">' . Text::_('SNIPPETS_CLOSE') . '</button><a href="' . Route::_('index.php?option=com_snippets&task=snippet.remove&id=' . $this->item->id, false, 2) . '" class="btn btn-danger btn-sm">' . Text::_('SNIPPETS_DELETE_ITEM') . '</a>'
                        ),
